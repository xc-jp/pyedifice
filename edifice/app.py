...
class App(object):
    ...
    Args:
        ...
        application_argv: the Qt application command line argv.
            This option is only relevant if create_application is True.
    ...
    def __init__(self,
        ...
        if create_application:
            if application_name is not None:
                self.app = QtWidgets.QApplication([application_name] + application_argv)
            else:
                self.app = QtWidgets.QApplication(application_argv)
