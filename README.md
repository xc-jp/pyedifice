...
Because __Edifice__ supports __PySide6__ and __PyQt6__ at the same time, neither
...
on __Edifice__ should also depend on either __PySide6__ or __PyQt6__.

## `App`

New Props:

- `application_argv` = The list of commandline arguments for [`QApplication` to parse](https://doc.qt.io/qtforpython-6/PySide6/QtWidgets/QApplication.html#detailed-description).